...
import (
	...
	"github.com/johnhany97/webApp/application"
	"github.com/johnhany97/webApp/models"
	"github.com/johnhany97/webApp/libunix"
)
...
func newConfig() (*viper.Viper, error) {
	...
	c := viper.New()
	c.SetDefault("dsn", fmt.Sprintf("postgres://%v@localhost:5432/webApp?sslmode=disable", u.Username))
	c.SetDefault("cookie_secret", "0zApvjOeY0FlFJQL")
